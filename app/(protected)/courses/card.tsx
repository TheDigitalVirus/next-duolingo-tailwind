...
export const Card = ({
  ...
  return (
    <div
      onClick={() => onClick(id)}
      className={cn(
        "flex h-full min-h-54.25 min-w-50 cursor-pointer flex-col items-center justify-between rounded-xl border-2 border-b-4 p-3 pb-6 hover:bg-black/5 active:border-b-2",
